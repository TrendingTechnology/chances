...
subtitle: Nibh phasellus dictumst feugiat, aptent cras platea aliquam integer purus, cum commodo massa netus justo nam.
date: '2019-01-01'
langs: ['en']
...
Since then I’ve done [a few more attempts](https://medium.com/@chancethedev/hot-reloading-in-react-1140438583bf?source=user_profile---------6------------------) to fix it, each flawed in a different way. One of them is still being used in React Native (hot reloading functions doesn’t work there because of my mistakes — sorry!)
